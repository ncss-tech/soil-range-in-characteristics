...
```{r echo=FALSE, warning=FALSE, fig.width=9, fig.height=5.25}
par(mar=c(4.5,1,3,1))
res <- percentileDemo(e.elev, hist.breaks=90, xlab='Elevation (m)', main='CA630: 5012')
kable(res, digits = 1)
```

```{r echo=FALSE, warning=FALSE, fig.width=9, fig.height=5.25}
par(mar=c(4.5,1,3,1))
res <- percentileDemo(e.slope, hist.breaks=90, xlab='Slope (%)', main='CA630: 5012')
kable(res, digits = 1)
```

```{r echo=FALSE, warning=FALSE, fig.width=9, fig.height=5.25}
par(mar=c(4.5,1,3,1))
res <- percentileDemo(e.MAP, hist.breaks=90, xlab='PRISM Mean Annual PPT (mm)', main='CA630: 5012')
kable(res, digits = 1)
```
