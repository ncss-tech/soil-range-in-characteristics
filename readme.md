...
[Recent discussions among some Soil Science Division staff](https://github.com/ncss-tech/soil-range-in-characteristics/blob/master/references/RV%20defnition%20email%20discussion.docx) have centered around the desire to have a quantitative definition for the "low, RV, and high" values, to better accomodate computationally derived values, when available, for populating the SSURGO database. There is currently this proposed edit to the National Soil Survey Handbook Part 618.55 for the population of Component Slope Gradient in NASIS:
