...
The following proposal attempts to formulate a quantitative definition for the terms "low, RV, high", while accomodating the legacy data for which no definition was established. The authors of this proposal would like to remind readers that the current alternative methods for the derivation of low, RV, and high values ("pick some numbers") cannot be replicated between individuals, and not sufficiently rigorous for a science-based agency.
